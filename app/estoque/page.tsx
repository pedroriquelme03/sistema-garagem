                  ...
                  <tr key={veiculo.id} className="hover:bg-slate-50/70">
                    ...
                    <td className="relative px-5 py-3 text-right">
                      <details className="group relative inline-block">
                        <summary aria-label={`Ações de ${nomeVeiculo(veiculo)}`} className="cursor-pointer list-none rounded-lg px-2 py-1 text-xl font-bold leading-none text-slate-500 hover:bg-slate-100 hover:text-slate-800">•••</summary>
                        <div className="absolute right-0 top-9 z-10 w-48 rounded-xl border border-slate-200 bg-white p-1 text-left shadow-lg">
