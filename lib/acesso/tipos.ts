...
export const RECURSOS_PLANO: { id: RecursoPlano; label: string; detalhe: string }[] = [
  ...
  { id: "vitrine-plus", label: "Site completo", detalhe: "Home com destaque, marcas, temas e simulação no site." },
  { id: "site-master", label: "Site sob medida", detalhe: "Showroom cinematográfico, ficha do carro e identidade da loja." },
...
export const PLANOS_PADRAO: DefinicaoPlano[] = [
  ...
  },
  {
    id: "pro",
    label: "Pro",
    resumo: "Essencial + FIPE no sistema e site da loja com destaque, marcas e temas.",
    precoMensal: 499.9,
  ...
  },
  {
    id: "master",
    label: "Master",
    resumo: "Tudo do Pro + showroom cinematográfico, FANDI e Banco BV.",
    precoMensal: 699.9,
